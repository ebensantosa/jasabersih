...
export function createClient(opts: ClientOptions) {
  ...
  return {
    ...
    admin: {
      ...
      listCleaners: (params?: { status?: string; q?: string; limit?: number; dateFrom?: string; dateTo?: string; sortBy?: string }) =>
        request<unknown[]>('GET', `/admin/cleaners${qs(params ? { status: params.status, q: params.q, limit: params.limit != null ? String(params.limit) : undefined, dateFrom: params.dateFrom, dateTo: params.dateTo, sortBy: params.sortBy } : undefined)}`),
      ...
      updateCleaner: (id: string, body: { bringsTools?: boolean; serviceAreas?: string[] }) =>
      ...
      listUsers: (params?: { q?: string; status?: string; role?: 'customer' | 'cleaner'; dateFrom?: string; dateTo?: string; sortBy?: string }) =>
