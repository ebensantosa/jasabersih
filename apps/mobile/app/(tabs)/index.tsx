        ...
        <SafeAreaView edges={['top']}>
          <View className="px-4 pb-2 pt-1">
            ...
            <Pressable
              ...
              className="mt-3 flex-row items-center gap-3 rounded-2xl bg-white px-4 py-3.5"
              style={{ elevation: 2 }}
            >
              ...
              <View className="flex-1">
                <View className="flex-row items-center gap-1.5">
                  ...
                  <View className="rounded bg-amber-100 px-1.5 py-0.5">
                    <Text className="font-bold text-[9px] text-amber-700">NEW</Text>
                  </View>
                </View>
                <Text className="font-medium mt-0.5 text-[11px] text-ink-500" numberOfLines={1}>
                  Pilih layanan sendiri · bayar sesuai pakai
                </Text>
              </View>
