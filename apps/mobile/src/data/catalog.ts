...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  { code: 'kamar',          name: 'Kamar Tidur',     description: 'Kamar tidur standar',          icon: BedDouble, iconColor: '#1D4ED8', iconBg: '#E0F2FE', imageUrl: UNS('photo-1505693416388-ac5ce068fe85'), startingPrice: 120_000, popular: true },
  { code: 'kamar_km_dalam', name: 'Kamar + Toilet',  description: 'Kamar tidur + kamar mandi',    icon: BedDouble, iconColor: '#1D4ED8', iconBg: '#E0F2FE', imageUrl: UNS('photo-1505693416388-ac5ce068fe85'), startingPrice: 160_000, popular: true },
