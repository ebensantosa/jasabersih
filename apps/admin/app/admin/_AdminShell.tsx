...
const NAV = [
  ...
  { href: '/admin/wallet', label: 'Dompet & Penarikan', icon: Wallet, badge: 'withdrawalsPending' as const },
  { href: '/admin/payment-methods', label: 'Metode Pembayaran', icon: CreditCard },
  { href: '/admin/disputes', label: 'Sengketa', icon: ShieldAlert, badge: 'disputesOpen' as const },
  { href: '/admin/fraud', label: 'Sinyal Fraud', icon: ShieldAlert },
  { href: '/admin/fraud-reports', label: 'Laporan Fraud', icon: ShieldAlert, badge: 'fraudReports' as const },
  ...
  { href: '/admin/calls', label: 'Monitor Panggilan', icon: Phone },
  { href: '/admin/services', label: 'Layanan', icon: Sparkles },
  { href: '/admin/addons', label: 'Add-On', icon: Package },
  { href: '/admin/hourly-tiers', label: 'Tarif Per-Jam', icon: Clock },
  { href: '/admin/subscription-tiers', label: 'Paket Langganan', icon: Clock },
  ...
  { href: '/admin/content', label: 'Konten / CMS', icon: FileText },
  ...
  { href: '/admin/app-settings', label: 'Pengaturan App', icon: Palette },
