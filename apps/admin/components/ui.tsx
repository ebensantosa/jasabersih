...
// PROVIDER
// ============================================================
export function UiProvider({ children }: { children: ReactNode }): React.ReactElement | null {
...
export function Switch({ checked, onChange, label }: { checked: boolean; onChange: (v: boolean) => void; label?: string }): React.ReactElement | null {
  return (
...
export function Badge({ children, variant = 'slate' }: { children: ReactNode; variant?: 'slate' | 'green' | 'red' | 'amber' | 'blue' | 'purple' }): React.ReactElement | null {
  const cls = {
